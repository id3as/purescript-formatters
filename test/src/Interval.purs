...
prop ∷ ∀ e f. Foldable f ⇒ String → f { str ∷ String | e } → ({ str ∷ String | e } → Effect Unit) → Free TestF Unit
prop = forAll (show <<< _.str)

intervalTest ∷ Free TestF Unit
intervalTest =
  suite "Data.Formatter.Interval" do
...
type ArbRecurringInterval
  = Array { str ∷ String, formatedStr ∷ String, interval ∷ I.RecurringInterval IsoDuration DateTime }
